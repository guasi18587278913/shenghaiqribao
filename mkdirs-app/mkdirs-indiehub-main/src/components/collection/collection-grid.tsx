...
import type { CollectionListQueryResult, ToolCollectionListQueryResult } from "@/sanity.types";
import CollectionCard, { CollectionCardSkeleton } from "./collection-card";

interface CollectionGridProps {
  collections: CollectionListQueryResult | ToolCollectionListQueryResult;
}
