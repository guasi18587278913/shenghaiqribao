...
// Tool
export type ToolInfo = ToolListQueryResult[number];
// ToolFullInfo has more fields (eg. introduction and related items)
export type ToolFullInfo = ToolFullInfoBySlugQueryResult;
// Blog
