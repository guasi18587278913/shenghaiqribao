...
import { getToolCollections } from "@/data/tool-collection";
import { COLLECTIONS_PER_PAGE } from "@/lib/constants";
import { constructMetadata } from "@/lib/metadata";

export const metadata = constructMetadata({
  title: "Collection",
  description: "Explore curated tools for indie makers by collections",
...
export default async function CollectionIndexPage({
  ...
  const { collections, totalCount } = await getToolCollections({
    currentPage,
  });
