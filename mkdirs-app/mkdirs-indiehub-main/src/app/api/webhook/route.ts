    ...
    if (user) {
      ...
      const res = await sanityClient
        ...
        .set({
          paid: true,
          featured:
            pricePlan === PricePlans.PRO || pricePlan === PricePlans.SPONSOR,
          pricePlan: pricePlan, // basic or pro or sponsor
          sponsor: pricePlan === PricePlans.SPONSOR,
          basicPlanStatus:
            pricePlan === PricePlans.BASIC
              ? BasicPlanStatus.SUCCESS
              : BasicPlanStatus.SUBMITTING,
          proPlanStatus:
