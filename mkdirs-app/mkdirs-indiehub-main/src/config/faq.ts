...
export const faqConfig: FAQConfig = {
  items: [
    ...
    {
      id: "item-4",
      question: "When is the Sponsor plan available?",
      answer:
        "The Sponsor plan is available from 11th March 2025. \nYou can order it now, and book your advertising period after that.",
    },
  ],
};
