      ...
      <div className="flex flex-col gap-4">
        ...
        >
          <div className="px-4 flex flex-col gap-4">
            ...
            {item.opensource && (
              <div className="flex flex-wrap gap-1">
                <span className="text-xs text-primary-foreground font-medium px-2 py-1 border bg-primary rounded-md" >
                  Open Source
                </span>
              </div>
            )}
            ...
            <p className="text-sm line-clamp-5 leading-relaxed min-h-[3rem]">
              {item.description}
            </p>
          </div>
        </Link>
