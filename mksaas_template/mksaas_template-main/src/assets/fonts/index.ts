...
export const fontNotoSans = Noto_Sans({
  ...
  weight: ['400', '500', '600', '700'], // 添加 400 字重以提供更多选择
  preload: true, // 启用预加载以提升性能
  fallback: [
    'system-ui',
    '-apple-system',
    'BlinkMacSystemFont',
...
export const fontNotoSansMono = Noto_Sans_Mono({
  ...
  weight: ['400', '500'], // 添加 500 字重用于代码高亮
  preload: true,
});
...
export const fontBricolageGrotesque = Bricolage_Grotesque({
  ...
  preload: false, // 装饰性字体，不预加载以节省初始加载时间
});
