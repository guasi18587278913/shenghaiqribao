  ...
  try {
    ...
    if (category) {
      return reports.filter((report) =>
        report.topics.some(
          (topic) => getCategorySlug(topic.category) === category
        )
      );
    }
...
export async function getCollectionsByCategory(
  ...
  console.warn(
    'getCollectionsByCategory: knowledgeCollection table not implemented'
  );
  return [];
}
...
export async function getFeaturedCollections(): Promise<KnowledgeCollection[]> {
  console.warn(
    'getFeaturedCollections: knowledgeCollection table not implemented'
  );
  return [];
}
...
export async function getAllCollectionsGrouped() {
  console.warn(
    'getAllCollectionsGrouped: knowledgeCollection table not implemented'
  );
  return {};
}
...
export async function getCollectionWithTopics(slug: string) {
  console.warn(
    'getCollectionWithTopics: knowledgeCollection/collectionTopic tables not implemented'
  );
  return null;
}
